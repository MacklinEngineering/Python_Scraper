...
def initialize():
    """
    Initialize LLM and vector database using llama-index.
    ...
    try:
        ...
        if USE_GRAPHRAG:
            ...
            from graphrag_utils import get_graphrag_index
            vector_index = get_graphrag_index()
            print("✅ Using GraphRAG (Neo4j) as vector DB")
        else:
            # --- Milvus integration ---
